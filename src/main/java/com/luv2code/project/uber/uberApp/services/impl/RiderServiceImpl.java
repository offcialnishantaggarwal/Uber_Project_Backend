...
import com.luv2code.project.uber.uberApp.dto.RideRequestDto;
import com.luv2code.project.uber.uberApp.dto.RiderDto;
import com.luv2code.project.uber.uberApp.entities.*;
...
import com.luv2code.project.uber.uberApp.repositories.RideRequestRepository;
import com.luv2code.project.uber.uberApp.repositories.RiderRepository;
import com.luv2code.project.uber.uberApp.services.DriverService;
import com.luv2code.project.uber.uberApp.services.RatingService;
import com.luv2code.project.uber.uberApp.services.RideService;
import com.luv2code.project.uber.uberApp.services.RiderService;
import com.luv2code.project.uber.uberApp.strategies.RideStrategyManager;
...
public class RiderServiceImpl implements RiderService {
    ...
    public RideDto cancelRide(Long rideId) {
        ...
        if(!rider.equals(ride.getRider())){
            throw new RuntimeException("Rider does not owns this ride with id: "+rideId);
        }
